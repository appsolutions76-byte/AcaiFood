      ...
      case 'cliente':
        return (
          <div className="space-y-3 text-sm text-zinc-600 dark:text-zinc-400">
            ...
            <p><strong>4. Processamento de Pagamento:</strong> As transações financeiras e pagamentos digitais (Pix) são processados com segurança por meio da instituição parceira <strong>Asaas IP S.A.</strong>, autorizada e regulada pelo <strong>Banco Central do Brasil</strong>.</p>
          </div>
        );
      case 'loja':
      case 'fornecedor':
        return (
          <div className="space-y-3 text-sm text-zinc-600 dark:text-zinc-400">
            ...
            <p><strong>4. Serviços Financeiros & Subconta BaaS:</strong> A abertura de subconta bancária, a custódia de valores, repasses automáticos e divisões de pagamento (Split) são processados pela instituição parceira <strong>Asaas IP S.A.</strong> (CNPJ 19.540.550/0001-21), autorizada pelo <strong>Banco Central do Brasil</strong>, em conformidade com as exigências regulatórias do BACEN e COAF (Resolução Conjunta nº 16/2025).</p>
          </div>
        );
      case 'motorista':
        return (
          <div className="space-y-3 text-sm text-zinc-600 dark:text-zinc-400">
            ...
            <p><strong>4. Serviços Financeiros & Subconta BaaS:</strong> O recebimento de fretes, custódia e transferência de valores para sua conta bancária são processados pela instituição parceira <strong>Asaas IP S.A.</strong> (CNPJ 19.540.550/0001-21), autorizada pelo <strong>Banco Central do Brasil</strong>, nos termos das normas do BACEN e COAF (Resolução Conjunta nº 16/2025).</p>
          </div>
        );
      default:
        return <p className="text-sm text-zinc-500">Ao usar a plataforma, você concorda com nossas políticas de privacidade e conduta. Os serviços de pagamento e subcontas são operados em parceria com a instituição Asaas IP S.A., autorizada pelo Banco Central do Brasil.</p>;
    }
  };
