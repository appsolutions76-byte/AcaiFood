...
export default function StorefrontPage() {
  ...
  return (
    <div className="min-h-screen bg-gray-50 dark:bg-zinc-950 pb-44 sm:pb-48 font-sans">
              ...
              <div className="p-6">
                  ...
                  {(() => {
                      ...
                      const storeSelectItems = [
                        { key: 'popular', label: `Açaí Popular (1L) - ${formatMoney(pricePopular)}`, isAvail: isPopAvail },
      ...
      <footer className="text-center py-6 px-4 text-xs border-t border-zinc-200 dark:border-zinc-800 mt-12 mb-8 space-y-1.5">
        <p className="font-semibold text-purple-700 dark:text-purple-300">AçaíFood © 2026 • Uma tecnologia AppSolutions76 por Eletromecânica Baia Ltda.</p>
        <AsaasPartnerBadge variant="footer" className="my-1" />
        <p className="font-semibold text-purple-700 dark:text-purple-300">Belém - PA • Todos os direitos reservados</p>
      </footer>
