-- ==========================================================
-- AÇAÍFOOD — PERFORMANCE & STABILITY PATCH (MIGRATION)
-- Versão: 20260902000000
-- ==========================================================

-- 1. Otimização da função is_admin() com STABLE e PARALLEL SAFE
-- Evita reexecução da subquery a cada linha avaliada pelo RLS
...
-- Tabelas auxiliares não precisam de REPLICA IDENTITY FULL, aliviando o banco
DO $$
BEGIN
